...
export default function MuseumClient({ museumId, initialData }: { museumId: string; initialData?: any }) {
    ...
    return (
        <div className={`w-full xl:max-w-4xl mx-auto p-0 sm:p-6 pb-0 sm:pb-6 mt-0 sm:mt-6 bg-white dark:bg-neutral-950 xl:bg-transparent xl:dark:bg-transparent min-h-screen xl:min-h-0 ${isExiting ? 'page-slide-out' : isFromBack ? 'page-slide-in-back' : 'page-slide-in'}`}>
